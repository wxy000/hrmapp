                    ...
                    <tr><td class="font3 fftd">
                        <table>
                            <tr>
                                ...
                                <td class="font3 fftd">状态：<input type="text" name="state" id="state" size="20" value="${user.state }"/></td>
                            </tr>

                            <tr>
                                <td class="font3 fftd">登录名：<input type="text" name="loginname" id="loginname" size="20" value="${user.loginname }"/></td>
